//! Minimal in-memory JSON model and serde adapters for action shape tests.
//!
...
//! `presslint-selectors` harness, adding the `bool` and `f64` scalars the action
//! payloads (`SpreadText`, `MinimumStrokeWidth`) require.
